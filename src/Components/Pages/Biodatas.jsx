...
const Biodatas = () => {
  ...
  return (
    <div className="flex flex-col mx-auto ">
      ...
      <h1 className="gloock-regular text-5xl text-center mt-20"> Biodatas of the BlissBonds Website</h1>
      ...
      <div className="flex flex-col lg:flex-row w-full mt-10">
        <div className="w-1/4 min-w-[250px] p-4 rounded-md">
          <h2 className="gilda-display-regular text-lg mb-3 text-center">Filter your biodata</h2>
          <BiodataFilter filters={filters} setFilters={setFilters} />
        </div>

        <div className="w-3/4 grid md:grid-cols-2 grid-cols-1 gap-8">
